...
<body>
    <div class="image">
        ...
        <main class="container">
            <h1>CADASTRE SUA SERIE</h1>
            <form action="/cadastrarSerie" method="post">
                <div class="formularioFilmes">
                    <div>
                        <input type="text" placeholder="Nome da Serie" class="input" name="nome" required>
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="number" placeholder="Quantas temporadas?" class="input" name="temporada" required>
                    </div>

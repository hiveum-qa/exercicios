...
<body>
    ...
    <main class="container">
        ...
        <section class="formCard">
            ...
            <form action="/cadastrarSerie" method="post">
                <div class="formularioFilmes">
                    ...
                    <div class="campo">
                        ...
                        <input type="text" placeholder="Digite o nome da serie" class="input" name="nome"id="nome"required>
                    </div>
                    ...
                    <div class="campo">
                        <label for="personagem"> Personagem principal</label>
                        <input type="text" placeholder="Digite o personagem" class="input" name="personagem" id="personagem"required>
                        </div>

                        <div class="campo">
                        <label for="temporada"> Temporada da serie</label>
                        <input type="text" placeholder="Digite quantas temporadas tem " class="input" name="temporada" id="temporada"required>
                        </div>
